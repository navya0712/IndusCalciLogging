...
public class TestCalci extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		calci = (ICalci) context.getBean("calci");
	}
	...
	public void testAddition() {
		...
		try {
			// 3. Actual Result
			CalciOutput calActualResult = calci.addition(calInputObj);
	...
	public void testSubtract() {
		...
		try {
		// 3. Actual Result
		CalciOutput calActualResult = calci.subtract(calInputObj);
	...
	public void testMultiply() {
		...
		try {
		// 3. Actual Result
		CalciOutput calActualResult = calci.multiply(calInputObj);
	...
	public void testDivision() {
		...
		try {
		// 3. Actual Result
		CalciOutput calActualResult = calci.division(calInputObj);
